...
<script id="tailwind-config">
        tailwind.config = {
            ...
            theme: {
                extend: {
                    colors: {
                        "primary": "#10B981", // Verde esmeralda vivo
                        "secondary": "#F59E0B", // Naranja cálido para alertas
                        "background-light": "#F8F9FA", // Gris muy claro
                        "background-dark": "#101922", // Equivalente oscuro
                        "surface-light": "#ffffff",
                        "surface-dark": "#1E2A3A", // Azul marino oscuro para sidebar y cards
...
<h1 class="text-xl font-bold text-text-light-primary dark:text-text-dark-primary">Finanzas PE</h1>
</div>
</div>
...
<!-- SectionHeader -->
<h2 class="text-text-light-primary dark:text-text-dark-primary text-2xl font-bold tracking-tight mb-6">Tu Perfil</h2>
...
<!-- TextField: Límite Diario y Presupuesto Mensual -->
<div class="relative">
<label class="flex flex-col w-full">
...
<span class="pointer-events-none absolute bottom-3 left-3 flex items-center text-text-light-secondary dark:text-text-dark-secondary">S/</span>
<input class="form-input pl-8 flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-text-light-primary dark:text-text-dark-primary focus:outline-none focus:ring-2 focus:ring-primary border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark h-12 placeholder:text-text-light-secondary dark:placeholder:text-text-dark-secondary px-4 text-base font-normal leading-normal transition-colors" placeholder="2500.00" type="number" value=""/>
</label>
</div>
<!-- Date Pickers -->
<div>
<label class="flex flex-col w-full">
<p class="text-text-light-primary dark:text-text-dark-primary text-sm font-medium leading-normal pb-2">Fecha de Ingreso</p>
<input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-text-light-primary dark:text-text-dark-primary focus:outline-none focus:ring-2 focus:ring-primary border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark h-12 placeholder:text-text-light-secondary dark:placeholder:text-text-dark-secondary px-4 text-base font-normal leading-normal transition-colors" type="date" value=""/>
</label>
</div>
<div>
<label class="flex flex-col w-full">
...
<button class="flex items-center justify-center gap-2 h-11 px-6 bg-primary text-white rounded-lg text-sm font-semibold hover:bg-primary/90 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-surface-dark">Guardar Cambios</button>
</div>
</div>
<!-- Security Card -->
<div class="bg-surface-light dark:bg-surface-dark p-6 sm:p-8 rounded-xl shadow-sm border border-border-light dark:border-border-dark">
<!-- SectionHeader -->
<h2 class="text-text-light-primary dark:text-text-dark-primary text-2xl font-bold tracking-tight mb-6">Seguridad y Contraseña</h2>
<div class="grid grid-cols-1 gap-6">
<div>
<label class="flex flex-col w-full">
<p class="text-text-light-primary dark:text-text-dark-primary text-sm font-medium leading-normal pb-2">Contraseña Actual</p>
...
<div class="mt-8 flex justify-end">
<button class="flex items-center justify-center gap-2 h-11 px-6 bg-primary text-white rounded-lg text-sm font-semibold hover:bg-primary/90 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-surface-dark">Actualizar Contraseña</button>
</div>
</div>
</div>
</main>
</div>
<!-- Toast Notification Example (hidden by default) -->
<div class="fixed top-5 right-5 bg-secondary text-white py-3 px-5 rounded-lg shadow-lg flex items-center gap-3 opacity-0 pointer-events-none" role="alert">
